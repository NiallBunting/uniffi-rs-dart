...
{% for variant in e.variants() -%}
  {% for field in variant.fields() %}
    ...
    class _{{ variant.name()|enum_variant_py }}Type {

    }
  {%- endfor %}
{% endfor %}

enum {{ type_name }}<_{{ type_name}}Type> {
    _,
    {% for variant in e.variants() -%}
    {{ variant.name()|enum_variant_py }}<_{{ variant.name()|enum_variant_py }}Type>,
    {% endfor %}
}
